...
#else
  SPECIALIZE_REDUCE(FuncSum, rccl_float8, 1, rccl_float8, cast_to_f8_from_f16((__builtin_amdgcn_cvt_scalef32_pk_f16_fp8(x.__x, 1.f, 0) + __builtin_amdgcn_cvt_scalef32_pk_f16_fp8(y.__x, 1.f, 0))[0]))
